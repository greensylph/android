...
public abstract class IgAsyncTask<Params, Progress, Result>
{
  ...
  private final FutureTask<Result> mFuture = new FutureTask(this.mWorker)
  {
    protected void done()
    {
      try
      {
        ...
        IgAsyncTask.this.postResultIfNotInvoked(localObject);
        return;
      }
      ...
      {
        while (true)
          IgAsyncTask.this.postResultIfNotInvoked(null);
      }
  ...
  private final WorkerRunnable<Params, Result> mWorker = new WorkerRunnable()
  {
    public Result call()
      throws Exception
    {
      IgAsyncTask.this.mTaskInvoked.set(true);
      Process.setThreadPriority(10);
      return IgAsyncTask.this.postResult(IgAsyncTask.this.doInBackground(this.mParams));
    }
  };
  ...
  public final IgAsyncTask<Params, Progress, Result> execute(Params[] paramArrayOfParams)
  {
    return executeOnExecutor(sDefaultExecutor, paramArrayOfParams);
  }

  public final IgAsyncTask<Params, Progress, Result> executeOnExecutor(Executor paramExecutor, Params[] paramArrayOfParams)
  {
    if (this.mStatus != Status.PENDING);
    switch (4.$SwitchMap$com$instagram$android$imagecache$IgAsyncTask$Status[this.mStatus.ordinal()])
    {
    default:
  ...
  {
    final Data[] mData;
    final IgAsyncTask mTask;

    AsyncTaskResult(IgAsyncTask paramIgAsyncTask, Data[] paramArrayOfData)
    {
      this.mTask = paramIgAsyncTask;
  ...
  private static class InternalHandler extends Handler
  {
    ...
    {
      IgAsyncTask.AsyncTaskResult localAsyncTaskResult = (IgAsyncTask.AsyncTaskResult)paramMessage.obj;
 ...
 * Qualified Name:     com.instagram.android.imagecache.IgAsyncTask
