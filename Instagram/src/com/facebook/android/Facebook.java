...
public class Facebook
{
  ...
  private boolean startSingleSignOn(Fragment paramFragment, String paramString, String[] paramArrayOfString, int paramInt)
  {
    int i = 1;
    Intent localIntent = new Intent();
    localIntent.setClassName("com.facebook.katana", "com.facebook.katana.ProxyAuth");
    ...
    if (paramArrayOfString.length > 0)
      localIntent.putExtra("scope", TextUtils.join(",", paramArrayOfString));
    int j;
    if (!validateActivityIntent(paramFragment.getActivity(), localIntent))
      j = 0;
    while (true)
    {
      return j;
      this.mAuthActivity = paramFragment.getActivity();
      this.mAuthPermissions = paramArrayOfString;
      this.mAuthActivityCode = paramInt;
      try
      {
  ...
  public void authorize(Fragment paramFragment, String[] paramArrayOfString, int paramInt, DialogListener paramDialogListener)
  {
    boolean bool = false;
    this.mAuthDialogListener = paramDialogListener;
    if (paramInt >= 0)
      bool = startSingleSignOn(paramFragment, this.mAppId, paramArrayOfString, paramInt);
    if (!bool)
      startDialogAuth(paramFragment.getActivity(), paramArrayOfString);
  }

  public void authorize(Fragment paramFragment, String[] paramArrayOfString, DialogListener paramDialogListener)
  {
    authorize(paramFragment, paramArrayOfString, 32665, paramDialogListener);
  }
  ...
  public void authorizeCallback(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    {
      return;
      label85: if ((str1.equals("access_denied")) || (str1.equals("OAuthAccessDeniedException")))
      {
      ...
      continue;
      label218: setAccessToken(paramIntent.getStringExtra("access_token"));
  ...
  public void dialog(Context paramContext, String paramString, Bundle paramBundle, DialogListener paramDialogListener)
  {
    ...
    while (true)
    {
      ...
      break;
      label152: new FbDialog(paramContext, str2, paramDialogListener).show();
    }
  }
    ...
    implements ServiceConnection
  {
    ...
    final Messenger messageReceiver = new Messenger(new Facebook.TokenRefreshServiceConnection.1(this));
